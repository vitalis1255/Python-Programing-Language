...
class User:
    ...
    def __init__(self, first_name, last_name, longin_attempts = 1):
        ...
        self.longin_attempts = longin_attempts
        self.user_profile = []
    ...
    def increment_login_attempts(self, longin_attempts ):
        """
        Increments the value of login_attempts by 1
        """
        self.longin_attempts += longin_attempts
        return self.longin_attempts
...
class Admin(User):
    ...
    """
    def __init__(self, first_name, last_name, privilages,longin_attempts=1):
        super().__init__(first_name, last_name, longin_attempts)
        self.instance_privilages = Privilages(privilages)
...
print()
print("user 1 after increment: ",user1.longin_attempts)
print("user 2 after increment: ",user2.longin_attempts)
print("user 3 after increment: ",user3.longin_attempts)
print("user 4 after increment: ",user4.longin_attempts)
print("user 5 after increment: ",user5.longin_attempts)
print()
...
print("Administrator's Privilages: ",admin.show_privileges())
print()
